import { z } from "zod";
import { cloudRecommendationSchema, createRecommendationSchema, } from "@cloud-recommender/shared";
...
export const yandexCloudStubResponseSchema = z.object({
    ...
    recommendations: z.array(cloudRecommendationSchema).min(1).max(7),
}).passthrough();
