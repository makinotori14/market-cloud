const demoRecommendations = [
    {
        ...
        description: "Управляемый Kubernetes-контур для микросервисов, autoscaling и стандартизированного деплоя.",
        finalScore: 96,
    ...
    },
    {
        ...
        description: "Контейнерный backend без управления серверами для API, webhook и фоновых сценариев с переменной нагрузкой.",
        finalScore: 91,
    ...
    },
    {
        ...
        description: "Надежная транзакционная база для истории промптов, результатов ранжирования и аудита ответов модели.",
        finalScore: 89,
    ...
    },
    {
        ...
        description: "Среда для экспериментов с качеством рекомендаций, датасетами, ручной разметкой и сравнением prompt-версий.",
        finalScore: 84,
    ...
    },
    {
        ...
        description: "Хранилище статических ассетов и быстрая доставка файлов интерфейса, отчетов и вложений пользователям.",
        finalScore: 78,
    ...
    },
    {
        ...
        description: "Метрики, логи и алерты для контроля latency, ошибок очереди, качества ответов и деградаций модели.",
        finalScore: 86,
    ...
    },
    {
        ...
        description: "LLM-слой для преобразования пользовательского промпта в структурированные облачные рекомендации.",
        finalScore: 94,
...
//# sourceMappingURL=yandex-cloud.stub.js.map